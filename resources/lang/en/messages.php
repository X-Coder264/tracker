...
return [
    ...
    'torrent.edit' => 'Edit',
    'invite_code_label_caption' => 'Invite code',
    'invites.no_invitees' => 'You have not invited anyone yet.',
    'invites.no_invites_left' => 'You do not have any invites at this moment.',
    'invites.create' => 'Create an invite',
    'invites.valid_invites' => 'Valid invites',
    'invites.valid_until' => 'Valid until',
    'invites.invited_users' => 'Invited users',
    'invites.user_name' => 'Username',
    'invites.user_created_at' => 'Registered at',
    'invites_no_invites_left_error_message' => 'You do not have any available invite left.',
    'invites_successfully_created_message' => 'You have successfully created an invite which expires in :count day.|You have successfully created an invite which expires in :count days.',
    '2fa_auth.caption' => 'Two-factor authentication',
    '2fa.info_message' => "Two-factor authentication provides stronger security for your account by requiring a second step of verification when you sign in. In addition to your password, you’ll also need a code generated by the Google Authenticator (or Authy) app on your phone.",
    '2fa.please_scan_barcode_message' => 'Please scan this barcode using <strong>Google Authenticator</strong> or <strong>Authy</strong> and then click the enable 2FA button.',
    '2fa.use_secret_key_message' => "If you can't scan the barcode, you can use this code directly in your application: <strong>:code</strong>",
    '2fa.enable_button.caption' => 'Enable two-factor authentication',
    '2fa.disable_button.caption' => 'Disable two-factor authentication',
